import 'dart:convert';
import 'package:mycabdriver/controllers/create_chat_room_and_start_conversation.dart';
...
import 'package:mycabdriver/models/current_trip_model.dart';
import 'package:mycabdriver/widgets/exit_trip_dialog.dart';
...
class _CurrentTripViewState extends State<CurrentTripView> {
  ...
  Future<void> _initModel() async {
    final String url =
        "https://gardentaxi.net/Back_End/public/api/tripe/get/${this.widget.driverId}";
      ...
      child: Directionality(
        ...
        child: Scaffold(
              ...
              : Container(
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      this._simpleListTile(
                          title: "إسم العميل",
                          trailing: "${this._currentTripModel.clientName}"),
                      this._simpleListTile(
                      ...
                      this._listTile(
                          title: "${this._currentTripModel.clientPhone}",
                          icon: Icons.call,
                          onTap: () async {
                            String url =
          ...
          bottomNavigationBar: GestureDetector(
            onTap: () {
              this._finishTrip(context);
              this._currentTripProvider.clearData();
            },
            child: Container(
